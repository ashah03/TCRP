...
# Load data
cv_feature_list, cv_label_list, meta_tissue_index_list, test_feature_list, test_label_list, test_tissue_list = load_data_cell_line(
    tissue_map, drug, K)
...
for i, test_tissue in enumerate(test_tissue_list):
    ...
    meta_learner = MetaLearner(meta_dataset, test_dataset, K, meta_lr, inner_lr, layer, hidden, tissue_num,
                               meta_batch_size, inner_batch_size, num_updates, num_inner_updates,
                               meta_tissue_index_list[i], num_trials)

    best_fewshot_train_loss, best_fewshot_train_corr, best_fewshot_test_loss, best_fewshot_test_corr = meta_learner.train()

    print(test_tissue, 'best few-shot train loss', best_fewshot_train_loss, 'best few-shot train corr',
